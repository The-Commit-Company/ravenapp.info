                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="mx-auto max-w-2xl text-center">
                            ...
                            <p className="mt-6 text-lg leading-8 text-gray-300">
                                An alternative to Slack or Teams, Raven is designed to be the place where your teammates engage. Organise discussions in channels. React with emojis. Share files, images and code snippets.<br /><br />All the good stuff. Free, forever.
                            </p>
